#Number of cases discontinued or declared admissible
library(readxl)
library(dplyr)
...
#Success Rate of Cases (The Committee found a violation of the Convention in admissable or partly admissable cases)
library(readxl)
library(dplyr)
...
#Which countries cite OP articles the most and which articles are most cited per country?
library(dplyr)
library(tidyr)
...
#Average age for victims in admissable/partly admissable vs. inadmissable cases
library(readxl)
library(dplyr)
...
#Gender differences between admissible/partly admissible vs. inadmissible cases
library(readxl)
library(dplyr)
...
#Parents submitting the case between admissible/partly admissible vs. inadmissible cases.
library(readxl)
library(dplyr)
